...
class SignUpForm(UserCreationForm):
    ...
    class Meta:
        model = User
        fields = ('username', 'first_name', 'last_name', 'email', 'password1', 'password2', 'last_login', 'is_superuser', 'is_staff', 'is_active', 'date_joined')
...
class EditProfileForm(UserChangeForm):
    ...
    last_login = forms.DateTimeField(widget=forms.TextInput(attrs={'class': 'form-control'}))
    ...
    date_joined = forms.DateTimeField(widget=forms.TextInput(attrs={'class': 'form-control'}))
